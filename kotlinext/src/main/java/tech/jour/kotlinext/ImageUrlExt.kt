...
fun String.lfitW540JPG(): String = "$this!lfit_w540_jpg"

fun String.lfitW1080JPG(): String = "$this!lfit_w1080_jpg"

fun String.videoJPG(): String = "$this!snapshot"

//头像
fun String.fillW50H50JPG(): String = "$this!fillw50_h50_jpg"
fun String.fillW100H100JPG(): String = "$this!fillw100_h100_jpg"
fun String.fillW300H300JPG(): String = "$this!fillw300_h300_jpg"
fun String.fillW540H540JPG(): String = "$this!fillw540_h540_jpg"
